...
class MyArrayListTest {
	...
	public void testIndexOfNull() {
		assertThat(mylist.indexOf(null), CoreMatchers.is(-1));
		mylist.add(null);
		assertThat(mylist.indexOf(null), CoreMatchers.is(3));
	}
	...
	public void testRemoveObject() {
		...
		boolean flag = mylist.remove((Integer) 2);
		assertThat(flag, equalTo(true));
		assertThat(mylist.size(), is(2));
		assertThat(mylist.get(1), is(new Integer(3)));
		// System.out.println("a"+Arrays.toString(mylist.toArray()));

		flag = mylist.remove((Integer) 1);
		assertThat(flag, equalTo(true));
